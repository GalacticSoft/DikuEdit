...
/////////////////////////////////////////////////////////////////////////////
//Header for the ProgEditWnd class
/////////////////////////////////////////////////////////////////////////////
...
class ProgEditWnd : public CWnd
{

public:
//   DECLARE_CONTROL(ProgEditWnd, CWnd);
   DECLARE_DYNAMIC(ProgEditWnd);

   ProgEditWnd();

	ProgEditWnd(CWnd * parent, 
               ...
               bool bShowHorizScroll = true);    // show the horizontal scroll bar?
...
private:
   ...
   void InsertTextLine(const CString &line, 
                        int i, 
   ...
   void SetTextLine(const CString &line, int i, bool bNoUndo = false, bool pUpdate = TRUE);
...
private:
   ...
   // output
   CPoint _DrawLine(CDC *pDC, const CString &line, const ProgText::lineVector &colors, int lineidx, int y);
